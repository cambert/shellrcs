...
(defconst verilog-mode-version (substring "$$Revision: 558 $$" 12 -3)
  "Version of this Verilog mode.")
(defconst verilog-mode-release-date (substring "$$Date: 2010-01-25 15:05:21 +0000 (Mon, 25 Jan 2010) $$" 8 -3)
...
find the errors."
   ...
   (if (boundp 'compilation-error-regexp-alist-alist)
       (progn
         (if (not (assoc 'verilog-IES compilation-error-regexp-alist-alist))
             (mapcar
              (lambda (item)
