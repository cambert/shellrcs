...
(defconst verilog-mode-version (substring "$$Revision: 662a $$" 12 -3)
  "Version of this Verilog mode.")
(defconst verilog-mode-release-date (substring "$$Date: 2011-01-19 17:39:27 +0000 (Wed, 19 Jan 2011) $$" 8 -3)
...
(defconst verilog-optional-signed-range-re
  (concat
   "\\s-*\\(\\<\\(reg\\|wire\\logic\\)\\>\\s-*\\)?\\(\\<signed\\>\\s-*\\)?\\(" verilog-range-re "\\)?"))
